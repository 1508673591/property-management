    ...
    template: 
	  ...
	  '<header class="main-header">'+
	    '<a href="javascript:;" class="logo">'+
	      ...
	      '<span class="logo-lg"><b>毓秀汇物业管理</b></span>'+
	    '</a>'+
    ...
    data: function() {
        return {
    		menuList:[{
				...
				"parentName": null,
				"name": "商品管理",
				"url": "/admin/shopping/shopping.html",
				"perms": null,
				"type": 1,
				...
				"parentName": null,
				"name": "支付记录",
				"url": "/admin/goodsPay/goodsPay.html",
				"perms": null,
				"type": 1,
				"icon": "fa fa-file-text",
				"orderNum": 4,
	...
	template:
	  '<footer class="main-footer">'+
	    '<div class="pull-right hidden-xs">'+
	      'Version 1.0'+
	    '</div>'+
	    'Copyright &copy;  <a href="https://www.gdufs.edu.cn/" target="_blank">GDUFS</a> All Rights Reserved'+
	  '</footer>'
});
